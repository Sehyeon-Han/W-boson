void Recoil_Z_data(const char* inFile = "/data2/kplee/Lecture/CMSOpenData/Data/SingleMuon/Run2016H/*.root",
                   const char* outFile = "recoil_Z_data.root",
                   double ptMin = 0,
                   double ptMax = 100,
                   double dPt = 2)
{   
...
void DrawBinFit(const char* rootFile = "recoil_Z_data.root",
                int ibin = 0,
                const char* which = "U1")
{
...
void DrawRecoilGraphs(const char* rootFile = "recoil_Z_data.root")
{
